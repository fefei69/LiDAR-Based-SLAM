...
if __name__ == "__main__":
    ...
    np.save(f"results/Estimated_trajectory_dataset{dataset}_change_icp_input.npy",pose_history)
    np.save(f"results/Estimated_trajectory_X_trajectory_dataset{dataset}.npy",X_trajectory)
    np.save(f"results/Estimated_trajectory_Y_trajectory_dataset{dataset}.npy",Y_trajectory)
    ...
    plt.legend()
    plt.savefig(f"results/Estimated_trajectory_dataset{dataset}_change_icp_input.png")
    plt.show()