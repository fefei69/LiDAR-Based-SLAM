...
import numpy as np
from utils import read_canonical_model, load_pc, data_association, visualize_icp_result, icp
...
if __name__ == "__main__":
    ...
    for i in range(num_pc):
        ...
        optimal_pc, pose = icp(source_pc, target_pc, down_sample_rate, data_num=i)
        ...
        visualize_icp_result(source_pc, optimal_pc, np.eye(4))
